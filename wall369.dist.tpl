...
<body>
<div id="loading"><img alt="" height="16" src="medias/loading.gif" width="16"></div>
<div id="mask"></div>
...
<div id="wall369_display">
	...
	<form action="?a=post" data-type="photo" enctype="multipart/form-data" id="post_photo" method="post" target="iframe_upload">
